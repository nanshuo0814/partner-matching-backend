package com.nanshuo.partnermatching.aop;
...
public class CustomAopConfig {
     ...
     * 切入带有 @Check 注解的方法。
     */
    @Pointcut("@annotation(com.nanshuo.partnermatching.annotation.Check)")
     ...
     */
    @Pointcut("@annotation(com.nanshuo.partnermatching.annotation.CheckAuth)")
     ...
     */
    @Pointcut("execution(* com.nanshuo.partnermatching.controller.*.*(..)) && !@annotation(com.nanshuo.partnermatching.annotation.Check)")
